...
var _console3, _console4, _console5, _console7, _console8, _console9, _console10, _console11, _console13;
...
var me = {
  name: 'Romina',
  age: 35,
  speak: function speak(language) {
    var _console;
    /* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("2853478133_0", "".concat(this.name, " speaks") + language)));
  },
  spend: function spend(money) {
    var _console2;
    /* eslint-disable */(_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("2853478133_1", "".concat(this.name, " spends") + money + "euro")));
    return money;
  },
  skills: 'cooking',
  numberPet: 3
...
me.fast = true;
/* eslint-disable */
(_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("2853478133_2", me)));
/*===========================================
...
myArray2.push(24);
/* eslint-disable */
(_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("2853478133_3", myArray2)));
var myArray3 = ["stringa", true, 22];
/* eslint-disable */
(_console5 = console).log.apply(_console5, _toConsumableArray(oo_oo("2853478133_4", myArray3)));
;
var people = [{
  userName: "Alice",
  password: "mtc",
...
var Admin = /*#__PURE__*/function () {
  ...
  _createClass(Admin, [{
    ...
    value: function format() {
      var _console6;
      return (/* eslint-disable */(_console6 = console).log.apply(_console6, _toConsumableArray(oo_oo("2853478133_5", "".concat(this.name, " gioca da ").concat(this.age, " anni"))))
      );
    }
  }]);
  return Admin;
}(); // Fase 3: istanza della classe
var pDisney1 = new Admin("Pluto", "Canis", 34);
var pDisney2 = new Admin("Paperino", "Paperinis", 22);
/* eslint-disable */
(_console7 = console).log.apply(_console7, _toConsumableArray(oo_oo("2853478133_6", pDisney1)));
/* eslint-disable */
(_console8 = console).log.apply(_console8, _toConsumableArray(oo_oo("2853478133_7", pDisney2)));
// Array tipizzato con class (alias-type)
var admins = [];
admins.push(pDisney1);
admins.push(pDisney2);
/* eslint-disable */
(_console9 = console).log.apply(_console9, _toConsumableArray(oo_oo("2853478133_8", admins)));
pDisney1.name = "Clarabella";
/* eslint-disable */
(_console10 = console).log.apply(_console10, _toConsumableArray(oo_oo("2853478133_9", pDisney1)));
/* eslint-disable */
(_console11 = console).log.apply(_console11, _toConsumableArray(oo_oo("2853478133_10", admins)));
/*==========================================================
=            6. PUBLIC, PRIVATE, READONLY CLASSES         =
===========================================================*/
var Good = /*#__PURE__*/function () {
  // Fase 1: costruttore 
  function Good(name, surname, age) {
  ...
  _createClass(Good, [{
    ...
    value: function format() {
      var _console12;
      return (/* eslint-disable */(_console12 = console).log.apply(_console12, _toConsumableArray(oo_oo("2853478133_11", "".concat(this.name, " gioca da ").concat(this.age, " anni"))))
      );
    }
  }]);
  return Good;
}();
var good = new Good("Minnie", "Topolinia", 26);
/* eslint-disable */
(_console13 = console).log.apply(_console13, _toConsumableArray(oo_oo("2853478133_12", good)));
...
/******/ 	__webpack_require__.O(undefined, ["css/style"], () => (__webpack_require__("./src/index.ts")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/style"], () => (__webpack_require__("./style.scss")))
